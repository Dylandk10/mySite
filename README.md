MySite is a website/we-app used for my portfolio website. The backend is built on Django and SQLite. While the front end is vanilla JavaScript, HTML and CSS.
